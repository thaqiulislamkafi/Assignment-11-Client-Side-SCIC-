            ...
            <div className='my-10 lg:mx-10'>
                ...
                <form onSubmit={handleAddMarathon} className="fieldset  border-base-300 rounded-box  border p-4 gird grid-cols-1 md:grid-cols-2  gap-5 my-10">
                    ...
                    <div className='flex flex-col gap-2'>
                        ...
                        <input type="text" name='name' className="input dark:bg-gray-900 w-full" placeholder="Enter Event Name" />
                    </div>

                    <div className='flex flex-col gap-2'>
                        <label className="label">Location</label>
                        <input type="text" name='location' className="input dark:bg-gray-900 w-full" placeholder="Enter event Location" />
                    </div>

                    <div className='flex flex-col gap-2'>
                        <label className="label">Registration Deadline</label>

                        <DatePicker name='deadline_date' className='input dark:bg-gray-900 w-full' selected={regiEnd} onChange={(regiEnd) => setRegiEnd(regiEnd)}></DatePicker>
                    </div>

                    <div className='flex flex-col gap-2'>
                        <label className="label">Select Category </label>
                        <select defaultValue="Pick a color" className="select dark:bg-gray-900 w-full" name='category'>
                    ...
                    <div className='flex flex-col gap-2'>
                        ...
                        <DatePicker name='start_date' className='input dark:bg-gray-900 w-full' selected={regiStart} ></DatePicker>
                    </div>
                    ...
                    <div className='flex flex-col gap-2'>
                        ...
                        <input type="text" name='details' className="input dark:bg-gray-900 w-full" placeholder="Enter event Details" />
                    </div>

                    <div className='flex flex-col gap-2'>
                        <label className="label">Registration Created</label>
                        <DatePicker name='event_created' className='input dark:bg-gray-900 w-full' selected={regiStart} ></DatePicker>
                    </div>
                    ...
                    <div className='flex flex-col gap-2 '>
                        ...
                        <input type="text" name='thumbnail' className="input w-full dark:bg-gray-900" placeholder="Enter Event Thumbnail" />
                    </div>

                    <div className='flex flex-col gap-2'>
                        <label className="label">Registration Count</label>
                        <input type="text" className="input dark:bg-gray-900 w-full" value='0' placeholder="" />
                    </div>

                    <button className='w-full btn md:col-span-2 dark:bg-gray-800 dark:text-gray-200'>Submit</button>
                </form>
            </div>
        </div>
    );
